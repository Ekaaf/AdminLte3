                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{URL::to('admin/fooditems/save')}}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="category_id" name="category_id" required>
                                        ...
                                        <option value="1" <?php if(old('category_id') == $cat->id) echo "selected"; ?>>{{$cat->category}}</option>
                                        @endforeach
                                    </select>
                                </div>
